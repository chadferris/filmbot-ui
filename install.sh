...
echo ""
echo "2. Set up ATEM network access (optional - for remote control):"
echo "   sudo ./setup_atem_forwarding.sh"
echo "   This allows ATEM Software Control from Mac/PC on WiFi"
echo ""
